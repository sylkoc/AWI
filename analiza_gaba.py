...
# zamiana zmiennych na kategorialne- nie wiem czy to jest wymagane tho
...
# WEIGHT
# print(data['WEIGHT'].mode()) #68.10, 72.64, 90.80
# print(data['WEIGHT'].mean()) #72,38
# print(data['WEIGHT'].median()) #71,28
# print(data['WEIGHT'].var()) #270,04
# print(data['WEIGHT'].std()) #16,43
# print(data['WEIGHT'].quantile(0.25)) #61,29
# print(data['WEIGHT'].quantile(0.75)) #83,08
# print(data['WEIGHT'].max()) #119,40
# print(data['WEIGHT'].min()) #30,87

# plt.boxplot(data['WEIGHT'])     #wykres pudełkowy
# plt.title('WAGA')
...
# print(st.pearsonr(data['WEIGHT'],data['PAIN 1']))
# współczynnik p > 0.05 dlatego nie ma związku

# //ZALEŻNOŚĆ MIĘDZY WAGĄ A BÓLEM TYPU 2
# print(st.pearsonr(data['WEIGHT'],data['PAIN 2']))
# współczynnik p > 0.05 dlatego nie ma związku

# //ZALEŻNOŚĆ MIĘDZY WAGĄ A BÓLEM TYPU 3
# print(st.pearsonr(data['WEIGHT'],data['PAIN 3']))
# współczynnik p > 0.05 dlatego nie ma związku

# //ZALEŻNOŚĆ MIĘDZY WAGĄ A BÓLEM TYPU 4
# print(st.pearsonr(data['WEIGHT'],data['PAIN 4']))
...
#
# plt.scatter(data['WEIGHT'], data['PAIN 4'])
# plt.xlabel('waga')
